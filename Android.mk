...
$(shell mkdir -p $(PRODUCT_OUT)/proprietary/vendor/lib/egl && pushd $(PRODUCT_OUT)/proprietary/vendor/lib > /dev/null && ln -s egl/libEGL_adreno.so libEGL_adreno.so && popd > /dev/null)
$(shell mkdir -p $(PRODUCT_OUT)/proprietary/vendor/lib64/egl && pushd $(PRODUCT_OUT)/proprietary/vendor/lib64 > /dev/null && ln -s egl/libEGL_adreno.so libEGL_adreno.so && popd > /dev/null)
